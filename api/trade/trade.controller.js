...
module.exports = {
    ...
    getAllTradeHis: (req, res) => {
        ...
        getAllTradeHis(req.query, (err, results) => {
            if(err){
                console.log(err);
                return;
            }
    ...
    getAllTradeHisTrash: (req, res) => {
        ...
        getAllTradeHisTrash(req.query, (err, results) => {
            if(err){
                console.log(err);
                return;
            }
    ...
    historyAllAddMoney: (req, res) => {
        ...
        historyAllAddMoney(req.query, (err, results) => {
            if(err){
                console.log(err);
                return;
            }
    ...
    getAllDepositHisTrash: (req, res) => {
        ...
        getAllDepositHisTrash(req.query, (err, results) => {
            if(err){
                console.log(err);
                return;
            }
