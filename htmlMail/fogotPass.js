                ...
                <tr>
                    <td colspan="2" align="center">
                        <div style="padding-left: 10px; padding-right: 10px; padding-top:15px; padding-bottom: 0px; color: #fff; margin-top: 5px;border-radius: 8px 8px 0 0;">
                            <div style="padding-bottom: 15px; font-size: 26px; font-weight: bold; position: relative;">Reset your password<span style="position: absolute; display: block; overflow: hidd=en; width: 114px; height: 5px; border-radius: 5px; bottom: 0; left: 50%; background-color: #7fbf19; transform: translateX(-50%);"></span>
                            </div>
                        </div>
                    </td>
                </tr>
