                ...
                [
                    ...
                    if (!results[0]) {
                        ...
                        const type = {
                            ...
                            type_en: `Recharge (Internal)`,
                            type_cam: `ប្រាក់បញ្ញើ (ផ្ទៃក្នុង)`
                        };

                        // insert

                        db.query(`INSERT INTO trade_history (pay_fee, paypal_order_id, from_u, to_u, paypal, type_key, type, type_en, type_cam, currency, amount, note, status, created_at)
                        values(?,?,?,?,?,?,?,?,?,?,?,now())`,
                            [
                                FEE,
                                paymentId,
