...
async function cleanData() {
    let listUsers = await new Promise((resolve, reject) => {
        ...
        db.query(
            ...
            AND userMain.nick_name NOT IN('Wacatrade','Thematian','Cambodia','Wacasale','bitcoin99','bitcoin8989','ciaozay','protrade37','niko7777','laonhaque69','wacacambodia','emily24','themartian')
